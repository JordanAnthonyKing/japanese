...
** Core non-logical sentence
  ...
  Just as with が, every sentence also has a は [[は]] marked topic, whether we can see it or not
  - アメリカ人です
  - ∅がアメリカ人です
  - ∅は∅がアメリカ人です
...
*** に (/ni/) - Target (Indirect Object)
    ...
    #+END_QUOTE
    # TODO There may be a more direct link for the い-stem
...
*** の (/no/) - Possessive
    ...
    <<の-adjectives>>
    # TODO Add a link to this secondary engine
...
<<で in A is B sentences>>
  で is not absolutely restricted to 'a does b' verb sentences (though most of the time it's used in verb sentences). What で is really restricted to is clauses that modify 用言 (See [[*Active and inactive words]])
...
*** は /wa/ topic exclusive <<は>>
    See also: [[*Core non-logical sentence]] [[*は vs が]]
  ...
  #+END_QUOTE
  # TODO add link to contrastive が
...
*** や (/ya/) - And (inclusive)
    ...
    #+END_QUOTE
*** と (/to/) - Quotation (and: _try_, _regard_, _as_ and _for_)
    #+BEGIN_QUOTE
...
***** Try
     ...
     # TODO Add a link to volitional form
...
***** As
     ...
     会長 *として* 。。。 - As President...
     #+END_QUOTE
     # TODO: Add link to て-form
     Note: して is the て-form of する and so another clause should follow
...
*** TODO (Move this) Pseudo-sentence enders
