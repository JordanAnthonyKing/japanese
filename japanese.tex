...
\label{sec:orgdefd6ca}
\subsection{The invisible が carriage}
\label{sec:org2036d93}
...
\label{sec:org5a2daa0}
\subsection{は particle}
\label{sec:orgca37fd8}
...
\label{sec:org19bdf95}
\subsection{Negative nouns}
\label{sec:org3637e0c}
...
\label{sec:org7d398e3}
\subsection{Ego-centrism}
\label{sec:org074d37a}
...
\label{sec:org2039346}
\subsection{Try - と する}
\label{sec:orgc68be60}
\begin{quote}
...
\label{sec:orge4203dd}
\subsection{Likeness}
\label{sec:orgbea7ee7}
...
\label{sec:org4f7a6fe}
\subsection{だけ}
\label{sec:org20d0667}
...
\label{sec:orgbb5274e}
\subsection{する verbs}
\label{sec:org7c72e70}
\begin{quote}
...
\section{{\bfseries\sffamily TODO} Extra: が particle becomes の in subordinate clauses}
\label{sec:org0e06684}
\end{document}
