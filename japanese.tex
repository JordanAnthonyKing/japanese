...
\label{sec:org2733b4a}
\subsection{The invisible が carriage}
\label{sec:org42bffb2}
...
\label{sec:org8a46026}
\subsection{は particle}
\label{sec:org8f89d10}
...
\label{sec:orgb7281ec}
\subsection{Negative nouns}
\label{sec:org7cd108f}
...
\label{sec:org96bdc9e}
\subsection{Ego-centrism}
\label{sec:orgff70839}
...
\label{sec:org252825c}
\subsection{Try - と する}
\label{sec:org5f9fe3d}
\begin{quote}
...
\label{sec:orga24fcfc}
\subsection{Likeness}
\label{sec:org812bdb8}
...
\label{sec:org3038e7d}
\subsection{だけ}
\label{sec:org926fab9}
...
\label{sec:org3496d94}
\subsection{する verbs}
\label{sec:orgcef8254}
\begin{quote}
...
\label{sec:orgd7bbe0f}
\subsection{ね}
\label{sec:org2687fba}
...
This can be used for a much wider range of things than just regret. To help understand all the varies uses of this expression, think of the English word 'done'.
