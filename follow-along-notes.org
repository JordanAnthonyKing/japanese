...
- Y=Xわけではない - Proposition Y does not have the /reasoning/ of entailing proposition X - The circumstance we're talking about doesn't have *that* reason (for it to be)
- Xわけがない - Proposition X does not have any reasoning (therefore it's not true) - *No* reasoning exists for that
#+BEGIN_QUOTE
