...
If we want to say something more natural like 'Sakura is walking' we must use the verb 'to be'[fn:1] , or in Japanese いる.
#+BEGIN_QUOTE
...
# --- FOOTNOTES ---
[fn:1] In English the verb 'to be' is irregular and has multiple forms be/is/are/am: To /be/ walking, Sakura /is/ walking, not Sakura /be/ walking.
